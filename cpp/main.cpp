...
void testAll(const int FROM_TEST, const int DESTINATION_TEST) {
	const int loopRepeats = 100;
	long long int dfsMediumTime = 0;
	int dfsMediumNodesCount = 0;
	long long int bfsMediumTime = 0;
	int bfsMediumNodesCount = 0;
	long long int aStarMediumTime = 0;
	int aStarMediumNodesCount = 0;
	for (int i = 0; i < loopRepeats; i++) {
		...
		cout << "End stop: " << test->stops[DESTINATION_TEST]->stop_name
				<< endl;
...
int main()
{
	...
	//testAll(FROM_TEST, DESTINATION_TEST);
	Gui interfejs;/////////////////////////
